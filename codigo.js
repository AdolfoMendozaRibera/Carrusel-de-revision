...
//Almacena el formulario en una variable para que sea mas facil llamarla
let persona1=Crear_perfil(perfil1[0],perfil1[1],perfil1[2],perfil1[3]);
let persona2=Crear_perfil(perfil2[0],perfil2[1],perfil2[2],perfil2[3]);
let persona3=Crear_perfil(perfil3[0],perfil3[1],perfil3[2],perfil3[3]);


//Selecciona la etiqueta que tiene el id "perfiles"
let perfiles=document.querySelector("#perfiles");
perfiles.innerHTML=persona1;
//Agrega las flechas para cambiar perfil.
perfiles.innerHTML +=`<img id="atras" class="flechas" alt="flecha_atras" src="flecha_atras.png">
<img id="adelante" class="flechas" alt="flecha_adelante" src="flecha_adelante.png">`;


//------------------------------------------------------------------------

//Cuando son llamadas, cargan las imagenes mas sus eventos.
const cargar_eventos_flechas=()=>
{
    //flecha atras
